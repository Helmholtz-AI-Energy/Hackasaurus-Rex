...
Welcome to `hackasaurus-rex` contributor's guide.
...
If you experience bugs or general issues with `hackasaurus-rex`, please have a look
...
You can help improve `hackasaurus-rex` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hackasaurus-rex` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hackasaurus-rex`'s files. While this mechanism can
...
```
conda create -n hackasaurus-rex python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hackasaurus-rex.git
   cd hackasaurus-rex
   ```
...
5. Install [pre-commit]:
   ...
   `hackasaurus-rex` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hackasaurus-rex
[issue tracker]: https://github.com/<USERNAME>/hackasaurus-rex/issues
